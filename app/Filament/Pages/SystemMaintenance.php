...
class SystemMaintenance extends Page
{
    ...
    public const PUBLIC_ASSET_FILES = ['robots.txt', 'llms.txt', 'BingSiteAuth.xml', 'favicon.ico', 'favicon-16x16.png', 'favicon-32x32.png', 'favicon-512.png', 'apple-touch-icon.png'];
