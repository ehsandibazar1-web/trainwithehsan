...
/**
 * دستیار هوش مصنوعی برای یک مقاله/صفحه‌ی مشخص — فقط از طریق دکمه‌ی «AI Assistant» در صفحه‌ی
 * ویرایش (?article=ID یا ?page=ID، همان قرارداد ?media=ID در MediaLibrary::mount()) قابل‌دسترس
 * است، در ناوبری اصلی ظاهر نمی‌شود چون بدون رکورد معنا ندارد. هر تولید صف می‌شود
 * (App\Jobs\RunAiContentGeneration) و هرگز خودکار روی رکورد نمی‌نویسد — Apply/Restore هر دو
 * کلیک صریح ادمین‌اند.
 */
class AiContentAssistant extends Page
{
    ...
    // کدام کارت خودشان را در پایین تب Generate دارند (نگاه کنید به ai-content-assistant.blade.php)
