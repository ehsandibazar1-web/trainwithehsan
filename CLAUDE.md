...
app/
  ...
  Models/
    ...
    Page.php                                 Standalone-page model — same bilingual two-row shape as Article, fully separate from blog; also `getOptimizedImageUrlAttribute()`, same as Article — see Section 21
