...
database/
  migrations/                                users, cache, jobs (Laravel defaults) + articles (incl. faqs column), media, site_settings, activity_log, pages, newsletter_subscribers, import_logs (incl. rollback columns), ai_templates/ai_prompts/ai_profiles (project-specific, dated 2026-07-xx)
lang/
