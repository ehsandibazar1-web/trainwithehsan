...
resources/
  views/
    ...
    filament/pages/                           Custom Filament page Blade views (homepage-settings, about-page-settings, menu-settings, footer-settings, editorial-calendar, activity-log, media-library)
