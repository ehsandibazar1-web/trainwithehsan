...
app/
  ...
  Services/Seo/VideoSchemaService.php        Builds VideoObject JSON-LD for the homepage video row + member videos (from existing data only, additive, no UI change) — Video SEO, see Section 8
  Services/Content/EmbedRenderer.php          Post-sanitize body processor — turns a standalone provider link into a click-to-load embed facade (no <iframe> stored/allowlisted), see Section 8
