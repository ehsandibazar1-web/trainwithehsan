        ...
        <div class="wrap">
            <div class="insta-showcase-grid reveal-group">
                <div class="insta-showcase-text reveal">
                    ...
                    <h2>{{ $v('insta_showcase_title', 'Yolculuğu Takip Edin') }}</h2>
                    <p>{{ $v('insta_showcase_subtitle', 'Gerçek antrenman anları, doğrudan Instagram\'dan.') }}</p>
                    <a href="{{ $instaFollowUrl }}" class="insta-showcase-btn" rel="noopener" target="_blank">
                        {{ $v('insta_showcase_button_text', 'Instagram\'da takip edin') }}
                    </a>
                </div>
